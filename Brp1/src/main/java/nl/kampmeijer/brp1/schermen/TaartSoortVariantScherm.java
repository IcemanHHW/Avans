...
public class TaartSoortVariantScherm {
    ...
    """);
            while (r.next()) {
                ...
                tsv.setSoort_id(r.getInt("variant_id"));
        ...
        addButton.setOnAction(_ -> {
            ...
            if (soort != null && variant != null) {
                int iResult = insertData("INSERT INTO taartsoortenvarianten(soort_id, variant_id) VALUES (" + soort.getId() + ", " + variant.getId() + ")");
        ...
        updateButton.setOnAction(_ -> {
            ...
            if (soort != null && variant != null) {
                int iResult = updateData("UPDATE taartsoortenvarianten SET soort_id = " + soort.getId() + ", variant_id = " + variant.getId() +
                        " WHERE soort_id = " + selectedItem.getSoort_id() + " AND variant_id = " + selectedItem.getVariant_id());
        ...
        deleteButton.setOnAction(_ -> {
            ...
            int iResult = updateData("DELETE FROM taartsoortenvarianten WHERE soort_id = " + selectedItem.getSoort_id() + " AND variant_id = " + selectedItem.getVariant_id());
